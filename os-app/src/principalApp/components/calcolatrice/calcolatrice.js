          ...
          <Row>
            <Col>
              ...
              <Button
                variant="info"
                style={buttonStyle}
                onClick={() => this.clearCalcolatrice()}
              >
                <h2>AC</h2>
              </Button>
            </Col>
